...
(assert (! (and (= (store ((as const (Array U U)) v) i1 v1) s1) (= (store s2 i3 v3) b)
(= v (select b i1)) (= (store ((as const (Array U U)) v) k21 v21) s21)
(= (store s22 k22 v22) b) (= v (select s31 i3))
(= (select s32 i3) (select b i3)) (not (p2 k21)) (not (p2 k22))
(not (p3 i3)) (not (= ((as const (Array U U)) v) b))) :named B))
