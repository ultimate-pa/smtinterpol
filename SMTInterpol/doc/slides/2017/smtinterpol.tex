...
%\title{SMTInterpol}
%\author[Jochen Hoenicke]{J{\"u}rgen Christ \and Jochen Hoenicke \and Alexander Nutz}
...
%    }
    ...
    \begin{scope}[overlay]
    \draw[fill=black] (-9,6.7) rectangle (9,9);
    \draw[fill=black] (-9,-6) rectangle (9,-4);
    \end{scope}
  \end{tikzpicture}
\end{frame}
\end{document}
