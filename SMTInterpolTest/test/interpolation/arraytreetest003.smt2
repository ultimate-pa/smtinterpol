...
(assert (! (and (< (select a i) 0) (and (= i y) (and (= i x1) (and (= i x2) 
	(and (= i x3) (and (= i x4) (not (= i k0)))))))) :named P0))
(assert (! (and (< 0 (select b j)) (and (= s3 (store s2 k2 v2))
	(not (= k2 x2)))) :named P1))
(assert (! (and (= y j) (and (= b (store (store s4 k3 v3) k4 v4))
	(and (not (= k3 x3)) (not (= k4 x4))))) :named P2))
(assert (! (= a (store s1 k0 v0)) :named P3))
(assert (! (and (= s2 (store s1 k1 v1)) (not (= k1 x1))) :named P4))
(assert (! (= s3 s4) :named P5))
