...
public interface ProofConstants {
	...
	public static final Annotation RW_BV2NAT = null; //TODO new Annotation(":bv2nat", null);
	public static final Annotation RW_NAT2BV = null; //TODO new Annotation(":nat2bv", null);
	public static final Annotation RW_BVADD2INT = null; //TODO
	...
	public final static  Annotation TAUT_NAT2BV = new Annotation(":todo", null); //TODO create annotation
	public static final Annotation TAUT_BV2NATLOW = new Annotation(":todo", null);
	public static final Annotation TAUT_BV2NATUP = new Annotation(":todo", null);
	public static final Annotation RW_BVTOINT_CONST = new Annotation(":todo", null);
	public static final Annotation RW_BVMUL2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVSUB2INT = new Annotation(":todo", null);
	public static final Annotation RW_CONCAT2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVUDIV2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVSHL2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVUREM2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVLSHR2INT = new Annotation(":todo", null);
	public static final Annotation RW_EXTRACT2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVEQ2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVULT2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVULE2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVUGT2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVUGE2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVSLT2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVSLE2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVSGT2INT = new Annotation(":todo", null);
	public static final Annotation RW_BVSGE2INT = new Annotation(":todo", null);
	public static final Annotation TAUT_BV2NAT = new Annotation(":todo", null);
