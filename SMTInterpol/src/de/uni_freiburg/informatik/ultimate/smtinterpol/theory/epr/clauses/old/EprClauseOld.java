 ...
 */
public abstract class EprClauseOld extends Clause {
...
//	private HashMap<Literal, Boolean> mFulfillabilityStatus = new HashMap<Literal, Boolean>();
	...
	public EprClauseOld(Literal[] literals, EprTheory eprTheory, boolean freshAlphaRenamed, TTSubstitution freshAlphaRen) {
		super(literals);
	...
	public EprClauseOld(Literal[] literals, ProofNode proof, Theory theory) {
		super(literals, proof);
		throw new UnsupportedOperationException();
	}

	public EprClauseOld(Literal[] literals, int stacklevel, Theory theory) {
		super(literals, stacklevel);
		throw new UnsupportedOperationException();
	}

	public EprClauseOld(Literal[] literals, ResolutionNode proof, int stacklevel, Theory theory) {
	...
	private static boolean doesUnifierChangeTheClause(TTSubstitution sub, EprClauseOld eprClause) {
		if (sub.isEmpty())
			return false;
	...
	public EprClauseOld instantiateClause(TTSubstitution sub) {
	 ...
	 * @return
	 */
	public EprClauseOld instantiateClause(Literal otherLit, TTSubstitution sub) {
	 ...
	 * @return
	 */
	public EprClauseOld instantiateClause(Literal otherLit, TTSubstitution sub, ArrayList<Literal> additionalLiterals) {
	...
	public abstract EprClauseOld getFreshAlphaRenamedVersion();
