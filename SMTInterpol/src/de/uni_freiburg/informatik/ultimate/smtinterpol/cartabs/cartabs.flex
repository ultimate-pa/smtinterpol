...
<YYINITIAL>  {
  ...
  "cartabs-init"         { return symbol(LexerSymbols.CARTABSINIT, yytext()); }
  "cartabs-error"        { return symbol(LexerSymbols.CARTABSERROR, yytext()); }
  "cartabs-stmt"         { return symbol(LexerSymbols.CARTABSSTMT, yytext()); }
  ...
  "declare-global"       { return symbol(LexerSymbols.DECLAREGLOBAL, yytext()); }
  "declare-local"        { return symbol(LexerSymbols.DECLARELOCAL, yytext()); }
  "define-sort"          { return symbol(LexerSymbols.DEFINESORT, yytext()); }
  "define-fun"           { return symbol(LexerSymbols.DEFINEFUN, yytext()); }
  "define-const"         { return symbol(LexerSymbols.DEFINECONST, yytext()); }
