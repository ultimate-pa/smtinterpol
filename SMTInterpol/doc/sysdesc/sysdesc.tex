...
This year, \SI comes with a new proof production that is based on resolution using a minimal set of axioms.  This is described in more detail below.
...
\SI runs with proof check mode enabled such that all proofs of unsatisfiability are tracked and checked.
