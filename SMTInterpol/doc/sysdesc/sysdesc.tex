...
We also have an experimental bit-vector solver based on a translation to integer arithmetic.  The bit-vector solver has no support for proofs yet, so there is no extra check to ensure soundness for unsat results.
